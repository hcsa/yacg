...
def export_to_creatures_sheet(creatures_sheet: xw.Sheet):
    ...
    creatures_sheet["H3"].options(index=False, header=False).value = df["spe"]
    creatures_sheet["M3"].options(index=False, header=False).value = df["atk-strong"]
    creatures_sheet["O3"].options(index=False, header=False).value = df["atk-strong-effect-variable"]
    creatures_sheet["P3"].options(index=False, header=False).value = df["atk-technical"]
